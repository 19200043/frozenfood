...
<body>
    ...
    <footer style="color: black !important; font-weight: bold;">
        <p class="copyright-agileinfo" style="color: black; font-weight: bold;"> &copy; 2022 <a href="<?= base_url(); ?>" style="color: black !important; font-weight: bold;"><?= get_store_name(); ?></a></p>
    </footer>

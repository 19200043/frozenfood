      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Menjual Hanya Makanan Terbaik</h1>
            <h2 class="subheading mb-4">Makanan Yang Kami Jual Selalu Dalam Keadaan Fresh Karna Dijaga Dengan Suhu Yang Tepat</h2>
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">100% Makanan Yang Kami Jual Sudah Bersertifikasi Halal</h1>
            <h2 class="subheading mb-4">Stiap Makanan Yang Kami Jual Telah Dilabeli Dengan Sertifikat Halal Dari MUI</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
      ...
      <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          ...
          <div class="media-body">
            ...
            <span>Dijaga dengan suhu yang tepat</span>
          </div>
        </div>
      </div>
      <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
